...
class GWM(nn.Module):
    ...
    def compute_loss(self, query_vectors, target_vectors, bi_loss_weight=1.0, fused_loss_weight=1.0):
        ...
        loss = fused_loss_weight * loss_fused + bi_loss_weight * 0.5 * (loss_text + loss_struct)
